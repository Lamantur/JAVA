...
public class OperationWithNotebook {
    ...
    public boolean notebookIsCorrect(Notebook notebook) {
        ...
        for (Criterion criterion : criterionList) {
            ...
            } else if (criterion.property.equals("processor")) {
            ...
            } else if (criterion.property.equals("video")) {
                valueNotebook = notebook.getVideo();
            } else {
                continue;
            }
...
class Criterion {
    ...
    public static Criterion startGetting(Scanner scanner, String property, boolean isQuantitative) {
        ...
        if (isQuantitative) {
            ...
            String quest = "Выберите критерий поиска: " +
                    "\n 1. Значение" +
                    "\n 2. Меньше" +
                    "\n 3. Больше" +
                    "\n 4. Интервал";
